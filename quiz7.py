...
folder_names = ["Users/ygkwo/Desktop/informationretrival/CBNU_InformationRetrival_homework/quiz7_doc"]  # Coding/Classes/boolean_query/
...
sample_pos_idx = pos_index["new"] #change pos_index 
...
query = "schizophrenia and new" #change query
